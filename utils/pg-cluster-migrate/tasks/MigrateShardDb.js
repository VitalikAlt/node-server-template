...
class MigrateShardDb extends EventEmitter {
    ...
    checkLastVersion() {
        this.shard.sqlQuery("SELECT MAX(version) as version FROM schema_version").then(this.onSuccessCheck.bind(this), this.onErrorCheck.bind(this))
    }
    ...
    addVersion(version, name, username) {
        ...
        this.shard.sqlQuery("INSERT INTO schema_version (version,revision,name,installed_by,installed_on,execution_time,success) VALUES ($1,0,$2,$3,$4,0,true)",[version,name,username,new Date()]).then(this.successInsert.bind(this), this.errorInsert.bind(this))
    }
